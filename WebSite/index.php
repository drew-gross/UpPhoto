...
<body>
    <div id="Background">
        <div id="Main">
            ...
            <div id="Info">
                <p>
                    UpPhoto is a fast and easy photo uploader for facebook. With UpPhoto, the time it
                    ...
                    whenever you take a photo, and you don't need to do a thing.
                </p>
                <p>
                    UpPhoto is not available yet, if you are interested, check back in a week or two.
                </p>
            </div>
        </div>
        <div id="Footer">
